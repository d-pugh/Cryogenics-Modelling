...
P_STP = 101325         # Pa
# ===================
# Measured saturation data for He-3
# ===================
...
if __name__ == "__main__":
    ...
    #ax_sat.plot(T_data, P_data, 'rx', ms=5, label='Data', alpha=0.7)
    ...
    ax_sat.set_title('He-3 Saturated Vapour Pressure')
    ax_sat.legend()
    ax_sat.grid(True, which='both', ls='--', alpha=0.4)
    plt.tight_layout()
    plt.savefig('He3_saturation_curve.png', dpi=300)
    plt.show()
    plt.close(fig1)
